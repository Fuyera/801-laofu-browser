...
更新：2026-09-16。**0.1.0-dev.3，macOS Apple Silicon 开发者预览版**。产品定位为连接 AI 助手与浏览器的本地浏览器助手。项目首页现提供中文／英文切换，功能介绍先展示任务与管理，再展示 23 种浏览器操作；版权与来源统一置于文末。网页控制台和详细指南仍为中文。P5、跨平台和日本服务器部署继续暂停；X 列表遗漏作为已知限制暂缓处理。
